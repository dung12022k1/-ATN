...
export default {
  ...
  methods: {
    async   getTours(id) {
      await TourService.detail(id).then(
          rs => {
            try {

              this.currentData = rs.data.result.recordset[0];
              this.iddata = this.currentData.Id;
              console.log(this.iddata);
              TourScheduleService.detail(this.currentData.Id).then(
                  res=>{
                   this.form = res.data.result;
                   console.log(this.form)
                    for (let i=0;i<this.form.length;i++){
                      this.formdetail[i].Detail = this.form[i].Detail
                    }
                  }
              )
    ...
    async handleSubmit(e){
      ...
      if(this.currentData.Duration >=1) {
        ...
        await   TourScheduleService.edit(this.form[0].Id,this.form[0]).then(
            rs=>{
              console.log(rs.data)
            }
        ).catch(err=>{
      ...
      if(this.currentData.Duration >=2) {
        ...
        await    TourScheduleService.edit(this.form[1].Id,this.form[1]).then(
            rs=>{
              console.log(rs.data)
            }
        ).catch(err=>{
      ...
      if(this.currentData.Duration >=3) {
        ...
        await TourScheduleService.edit(this.form[2].Id,this.form[2]).then(
            rs=>{
              console.log(rs.data)
            }
        ).catch(err=>{
      ...
      if(this.currentData.Duration >=4) {
        ...
        await TourScheduleService.edit(this.form[3].Id,this.form[3]).then(
            rs=>{
              console.log(rs.data)
            }
        ).catch(err=>{
      ...
      if(this.currentData.Duration >=5) {
        ...
        await TourScheduleService.edit(this.form[4].Id,this.form[4]).then(
            rs=>{
              console.log(rs.data)
            }
        ).catch(err=>{
      ...
      if(this.currentData.Duration >=6) {
        ...
        await TourScheduleService.edit(this.form[5].Id,this.form[5]).then(
            rs=>{
              console.log(rs.data)
            }
        ).catch(err=>{
      ...
      if(this.currentData.Duration >=7) {
        ...
        await TourScheduleService.edit(this.form[6].Id,this.form[6]).then(
            rs=>{
              console.log(rs.data)
            }
        ).catch(err=>{
      ...
      if(this.currentData.Duration >=8) {
        ...
        await TourScheduleService.edit(this.form[7].Id,this.form[7]).then(
            rs=>{
              console.log(rs.data)
            }
        ).catch(err=>{
      ...
      if(this.currentData.Duration >=9) {
        ...
        await TourScheduleService.edit(this.form[8].Id,this.form[8]).then(
            rs=>{
              console.log(rs.data)
            }
        ).catch(err=>{
        ...
        await TourScheduleService.edit(this.form[9].Id,this.form[9]).then(
            rs=>{
              console.log(rs.data)
            }
        ).catch(err=>{
      ...
      if(this.currentData.Duration >=11) {
        ...
        await TourScheduleService.edit(this.form[10].Id,this.form[10]).then(
            rs=>{
              console.log(rs.data)
            }
        ).catch(err=>{
